...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2026/06/09 09:51:24 by mgama             #+#    #+#             */
/*   Updated: 2026/06/09 09:51:26 by mgama            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void run_sl(const char *args)
{
	...
	max_length += (CAR_COUNT * car_width);
	...
	for (int x = VGA_WIDTH - 1; x > -max_length; --x)
	{
		...
		if (LOGO == 1)
			...
			add_C51(x, move_smoke);
		else
			add_D51(x, move_smoke);
...
int add_D51(int x, int move_smoke)
{
	...
	static char *car[D51HEIGHT + 1]  = {CAR01,  CAR02,  CAR03,  CAR04,  CAR05,  CAR06,  CAR07,  CAR08,  CAR09,  CAR10,  CARDEL};
...
int add_C51(int x, int move_smoke)
{
	...
	static char *car[C51HEIGHT + 1]  = {CARDEL,  CAR01,  CAR02,  CAR03,  CAR04,  CAR05,  CAR06,  CAR07,  CAR08,  CAR09,  CAR10,  CARDEL};
